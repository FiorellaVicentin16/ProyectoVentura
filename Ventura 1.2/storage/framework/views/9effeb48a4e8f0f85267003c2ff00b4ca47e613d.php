    ...
    <nav class="navbar-default navbar-static-top color-nav top">
        <div class="container">
            <div class="navbar-header ">
                ...
                <img class="margen" src="../images/Logotipo.png" width="180" height="100">
                </a>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    <li><a href="<?php echo e(url('/bienvenidos')); ?>"><p class="naranja Lato pequenio top-letras">Inicio</p></a></li>
                </ul>
