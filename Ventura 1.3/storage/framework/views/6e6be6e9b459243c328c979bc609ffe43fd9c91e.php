   ...
   <div class="back color-nav top">
    <div class="row">
        <div class="col-md-8 col-md-offset-2 espacio">
                <div class="panel-heading naranja LatoR pequenio">Registrarse</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/register')); ?>">
                        ...
                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            <label for="name" class="col-md-4 control-label naranja LatoR ">Nombre</label>
                        ...
                        <div class="form-group<?php echo e($errors->has('password_confirmation') ? ' has-error' : ''); ?>">
                            <label for="password-confirm" class="col-md-4 control-label naranja LatoR">Confirmar Contraseña</label>
